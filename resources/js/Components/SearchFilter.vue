<template>
  <div class="flex items-center">
    <div class="flex w-full bg-white shadow rounded">
      <dropdown
        ...
        class="
          ...
          border-r
          hover:bg-gray-100
          focus:border-white focus:ring focus:z-10
        "
      ...
      <input
        class="relative w-full px-4 py-2 rounded-r focus:ring"
        autocomplete="off"
        type="text"
        name="search"
        placeholder="Search…"
    ...
    <button
      class="ml-3 text-gray-500 hover:text-gray-700 focus:text-indigo-500"
      type="button"
      @click="$emit('reset')"
    >
      Reset
